...
/**
* Interface for generating pseudorandom numbers drawn from a logistic distribution with pre-specified parameter values.
*/
...
/**
* Interface for generating pseudorandom numbers drawn from a logistic distribution without pre-specified parameter values.
*/
