...
```javascript
logistic = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-logistic@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-array-logistic/tags). For example,

```javascript
logistic = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-logistic@v0.1.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-array-logistic@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/random-array-logistic/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/random-array-logistic/actions/workflows/test.yml?query=branch:v0.1.0
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/random-array-logistic.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-array-logistic/main
